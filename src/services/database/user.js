    ...
    getUser(user) {
        return new Promise((resolve, reject) => {
            try {
                ...
                reject(new Error(`Occurred an error during the execution of getUser function`))
            }
        })
    },
    getUserById(_id) {
    ...
    updateUser(user) {
        return new Promise((resolve, reject) => {
            try {
                ...
                reject(new Error(`Occurred an error during the execution of updateUser function`))
            }
        })
